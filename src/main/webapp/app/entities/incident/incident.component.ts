...
export class IncidentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.incidentService
      ...
      .subscribe(
        (res: HttpResponse<IIncident[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IIncident[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
