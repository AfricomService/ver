...
export class ResourceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.resourceService
      ...
      .subscribe(
        (res: HttpResponse<IResource[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInResources(): void {
    this.eventSubscriber = this.eventManager.subscribe('resourceListModification', () => this.loadPage());
  }
