...
export class RiskComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.riskService
      ...
      .subscribe(
        (res: HttpResponse<IRisk[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInRisks(): void {
    this.eventSubscriber = this.eventManager.subscribe('riskListModification', () => this.loadPage());
  }
